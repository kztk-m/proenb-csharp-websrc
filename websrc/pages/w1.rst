...
.. note:: 
   ...
   クラスと，こうした構造体定義と関数のあつまりの違いには `次回 <./w2.html>`_ 触れる．
...
``Int32.Parse``もstaticメソッドの一つである．また，``Console.WriteLine``も実はstaticメソッドであった．
...
.. admonition:: 例
   ...
   式の型が明らかな場合には「型」の部分に型を書く代わりに``var``と書くことができる．たとえば上記は
