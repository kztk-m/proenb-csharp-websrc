...
.. caution:: 
   ...
   を用いた環境構築法を紹介することとする．Visual Studio を使いたい人は `2023年度の環境構築法 <./setup_gui_2023.html>`_ を参照されたし．
...
#. （Macの場合のみ）これまでにインストール済でなければ，以下のコマンドを実行してXcode command line toolsをインストールする．
